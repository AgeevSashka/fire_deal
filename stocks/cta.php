...
<body>
  <section class="menu-head">
   ...
   <section>
     <div class="container cont">
         <div class="broadcast-title"> <img src="../img/baseball-left.png" alt="#">Доставка<img src="../img/baseball-right.png" alt="#"></div>
                <div class="container cont">
                  <broad-img>
                    <a href="https://eda.yandex/restaurant/Riverside"><img src="../img/yada.JPG"></a>
                  </broad-img>
                </div>
 ...
 <script src="https://api-maps.yandex.ru/2.1/?apikey=<ваш API-ключ>&lang=ru_RU"></script>
   ...
   <script src="../js/wow.min.js"></script>
    ...
    $.ajax({
        ...
        $(this).find("input").val("");
        swal("Спасибо!", "Мы вам перезвоним!", "success")
        $("form").trigger("reset");
        $('.overlay').hide();
    });
    return false;
