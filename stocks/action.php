...
<body>
  <section class="menu-head">
   ...
   <section class="main" id="main">
	...
	<section>
		<div class="container cont">
			<div class="ac-first__wrap">
				<div class="ac-first__title">
					<img src="../img/baseball-left.png" alt="">
						Акции
					<img src="../img/baseball-right.png" alt="">
				</div>
				<!-- /.ac-first__title -->
				<div class="ac-first__subtitle">
					<div class="ac-first__image-block">
						<img src="../img/stock/sale1.png" alt="#">
					</div>
					<!-- /.ac-first__image-block -->
					<div class="acc-first__text-block">
						<div class="acc-first__text-block__title">
							Проведите свое мероприятие с нами!
						</div>
						<!-- /.acc-first__text-block__title -->
						<div class="acc-first__text-block__subtitle">
							Закажите у нас банкет! С нас живая музыка в подарок!
Мы готовы рассмотреть все ваши пожелания!!!
						</div>
						<!-- /.acc-first__text-block__subtitle -->
						<button class="button">Заказать банкет</button>
					</div>
					<!-- /.acc-fist__text-block -->
				</div>
				<!-- /.ac-first__subtitle -->
			</div>
			<!-- /.ac-first__wrap -->
		...
		<div class="container cont">
			<div class="ac-first__wrap">
				<div class="ac-first__subtitle">
					<div class="acc-first__text-block acc-sec">
						<div class="acc-sec__text-block__title">
							Только в Riverside pub прийди и назови пароль:
						...
						<!-- /.acc-first__text-block__title -->
						<div class="acc-sec__text-block__subtitle">
							BaseballClub
						</div>
						<!-- /.acc-first__text-block__subtitle -->
						<div class="acc-sec__text-block__title">и получи скидку 10% на все!</div>
					</div>
					<!-- /.acc-fist__text-block -->
					<div class="ac-first__image-block">
						<img src="../img/stock/foto4.jpg" alt="#">
					</div>
					<!-- /.ac-first__image-block -->
				</div>
				<!-- /.ac-first__subtitle -->
